...
@media screen and (max-width: 768px) {
    ...
    theme11: `@import url('https://fonts.googleapis.com/css2?family=Quicksand:wght@300;400;500;600;700&family=Mulish:wght@300;400;600;700&display=swap');
...
@keyframes sparkleShine {
    0%, 100% {
        text-shadow: 0 0 10px rgba(255, 179, 209, 0.6),
                     0 0 20px rgba(255, 192, 221, 0.4);
    }
    50% {
        text-shadow: 0 0 20px rgba(255, 179, 209, 0.9),
                     0 0 40px rgba(255, 192, 221, 0.7),
                     0 0 60px rgba(255, 179, 209, 0.5);
    }
}

body {
    font-family: 'Mulish', 'Quicksand', sans-serif;
    background: linear-gradient(135deg, #fff5f9 0%, #ffe8f0 50%, #ffd8e8 100%);
    color: #8b5a7d;
    line-height: 1.8;
    overflow-x: hidden;
}
...
body::before {
    ...
    height: 100%;
    background-image: 
        radial-gradient(circle at 20% 30%, rgba(255, 179, 209, 0.15) 0%, transparent 50%),
        radial-gradient(circle at 80% 70%, rgba(255, 192, 221, 0.15) 0%, transparent 50%);
    pointer-events: none;
    z-index: -1;
}

#header {
    background: linear-gradient(135deg, #ffb3d1 0%, #ffc0dd 50%, #ffd4e9 100%);
    padding: 0;
    box-shadow: 0 8px 32px rgba(255, 179, 209, 0.4);
    position: relative;
    overflow: hidden;
}
...
#header::before {
    ...
    animation: sakuraPetal 20s linear infinite;
}
...
.ten-bao {
    ...
    letter-spacing: 8px;
    margin-bottom: 1.5rem;
    animation: sparkleShine 3s ease infinite;
    text-shadow: 0 0 10px rgba(255, 179, 209, 0.6),
                 2px 2px 4px rgba(255, 77, 148, 0.3);
}
...
.ten-bao::before {
    ...
    margin-right: 1.5rem;
    font-size: 3rem;
    animation: floatBubble 2s ease infinite;
}
...
.ten-bao::after {
    ...
    margin-left: 1.5rem;
    font-size: 3rem;
    animation: floatBubble 2s ease infinite 1s;
}
...
.gioi-thieu {
    ...
    border-radius: 30px;
    box-shadow: 0 15px 50px rgba(255, 179, 209, 0.3);
    position: relative;
}
...
.gioi-thieu h2 {
    ...
    font-weight: 700;
    letter-spacing: 6px;
    text-shadow: 0 2px 8px rgba(255, 179, 209, 0.4);
}
...
.bai-viet {
    ...
    border-radius: 25px;
    box-shadow: 0 10px 40px rgba(255, 179, 209, 0.25);
    transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
}

.bai-viet:hover {
    transform: translateY(-8px);
    box-shadow: 0 20px 60px rgba(255, 179, 209, 0.4);
    border-color: #ff4d94;
}
...
.audio-player {
    background: linear-gradient(135deg, #ffb3d1 0%, #ffc0dd 100%);
    padding: 2.5rem;
    margin: 3rem 0;
    border-radius: 25px;
    box-shadow: 0 10px 40px rgba(255, 179, 209, 0.3);
    text-align: center;
}
...
.khu-vuc-binh-luan textarea:focus {
    outline: none;
    border-color: #ff4d94;
    box-shadow: 0 0 20px rgba(255, 179, 209, 0.3);
}

.nut-gui {
    background: linear-gradient(135deg, #ff4d94 0%, #ff80b3 100%);
    color: white;
    padding: 1.2rem 3rem;
    border: none;
    border-radius: 50px;
...
.nut-gui:hover {
    ...
    background: linear-gradient(135deg, #ff3380 0%, #ff6699 100%);
}
...
.thong-tin-footer {
    ...
    letter-spacing: 2px;
    font-weight: 500;
    text-shadow: 0 2px 4px rgba(255, 77, 148, 0.3);
}
...
@media screen and (max-width: 768px) {
    ...
    .gioi-thieu, .bai-viet, .khu-vuc-binh-luan {
        padding: 2rem;
    }
}`,
    theme12: `@import url('https://fonts.googleapis.com/css2?family=Comfortaa:wght@300;400;500;600;700&family=Quicksand:wght@300;400;500;600;700&display=swap');
...
@keyframes purpleGlow {
    0%, 100% {
        text-shadow: 0 0 10px rgba(180, 165, 213, 0.6),
                     0 0 20px rgba(155, 127, 214, 0.4);
    }
    50% {
        text-shadow: 0 0 20px rgba(180, 165, 213, 0.9),
                     0 0 40px rgba(155, 127, 214, 0.7),
                     0 0 60px rgba(180, 165, 213, 0.5);
    }
}
...
body {
    ...
    background: linear-gradient(135deg, #f0ebf8 0%, #e6dff5 50%, #d8cff0 100%);
    color: #6b5b8a;
    line-height: 1.8;
    overflow-x: hidden;
}
...
body::before {
    ...
    height: 100%;
    background-image: 
        radial-gradient(circle at 25% 25%, rgba(180, 165, 213, 0.2) 0%, transparent 50%),
        radial-gradient(circle at 75% 75%, rgba(155, 127, 214, 0.2) 0%, transparent 50%);
    pointer-events: none;
    z-index: -1;
    animation: lavenderMist 15s ease infinite;
}

#header {
    background: linear-gradient(135deg, #b4a5d5 0%, #9b7fd6 50%, #c9b8e6 100%);
    padding: 0;
    box-shadow: 0 8px 32px rgba(155, 127, 214, 0.4);
    position: relative;
    overflow: hidden;
}
...
#header::before {
    ...
    animation: floatDream 25s linear infinite;
}
...
.ten-bao {
    ...
    letter-spacing: 10px;
    margin-bottom: 1.5rem;
    animation: purpleGlow 3s ease infinite;
    text-shadow: 0 0 15px rgba(180, 165, 213, 0.7),
                 2px 2px 6px rgba(124, 77, 255, 0.4);
}
...
.ten-bao::before {
    ...
    margin-right: 1.5rem;
    font-size: 3.5rem;
    animation: floatDream 3s ease infinite;
}
...
.ten-bao::after {
    ...
    margin-left: 1.5rem;
    font-size: 3.5rem;
    animation: floatDream 3s ease infinite 1.5s;
}
...
.gioi-thieu {
    background: linear-gradient(135deg, #f5f2fa 0%, #ebe5f7 100%);
    padding: 4rem;
    margin: 4rem 0;
    border: 3px solid #b4a5d5;
    border-radius: 35px;
    box-shadow: 0 15px 50px rgba(155, 127, 214, 0.35);
    position: relative;
}
...
.gioi-thieu h2 {
    ...
    font-weight: 700;
    letter-spacing: 7px;
    text-shadow: 0 2px 10px rgba(180, 165, 213, 0.5);
}
...
.bai-viet {
    ...
    padding: 3rem;
    margin: 3rem 0;
    border: 2px solid #c9b8e6;
    border-radius: 30px;
    box-shadow: 0 10px 40px rgba(155, 127, 214, 0.25);
    transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
}

.bai-viet:hover {
    transform: translateY(-8px);
    box-shadow: 0 20px 60px rgba(155, 127, 214, 0.4);
    border-color: #7c4dff;
}
...
.audio-player {
    background: linear-gradient(135deg, #b4a5d5 0%, #9b7fd6 100%);
    padding: 2.5rem;
    margin: 3rem 0;
    border-radius: 30px;
    box-shadow: 0 10px 40px rgba(155, 127, 214, 0.35);
    text-align: center;
}
...
.khu-vuc-binh-luan textarea:focus {
    outline: none;
    border-color: #7c4dff;
    box-shadow: 0 0 20px rgba(155, 127, 214, 0.3);
}
...
.thong-tin-footer {
    ...
    letter-spacing: 3px;
    font-weight: 500;
    text-shadow: 0 2px 5px rgba(124, 77, 255, 0.4);
}
...
@media screen and (max-width: 768px) {
    ...
    theme13: `@import url('https://fonts.googleapis.com/css2?family=Mali:wght@300;400;500;600;700&family=Comfortaa:wght@300;400;500;600;700&display=swap');
...
@keyframes peachGlow {
    0%, 100% {
        text-shadow: 0 0 15px rgba(255, 196, 163, 0.6),
                     0 0 25px rgba(255, 184, 140, 0.4);
    }
    50% {
        text-shadow: 0 0 25px rgba(255, 196, 163, 0.9),
                     0 0 50px rgba(255, 184, 140, 0.7),
                     0 0 75px rgba(255, 196, 163, 0.5);
    }
}
...
body {
    font-family: 'Comfortaa', 'Mali', sans-serif;
    background: linear-gradient(135deg, #fff7f0 0%, #ffede0 50%, #ffe4d0 100%);
    color: #9d6b53;
    line-height: 1.8;
    overflow-x: hidden;
}
...
body::before {
    ...
    height: 100%;
    background-image: 
        radial-gradient(circle at 30% 40%, rgba(255, 196, 163, 0.18) 0%, transparent 50%),
        radial-gradient(circle at 70% 60%, rgba(255, 184, 140, 0.18) 0%, transparent 50%);
    pointer-events: none;
    z-index: -1;
    animation: bubbleFloat 12s ease infinite;
}

#header {
    background: linear-gradient(135deg, #ffc4a3 0%, #ffb88c 50%, #ffd4bd 100%);
    padding: 0;
    box-shadow: 0 8px 32px rgba(255, 184, 140, 0.45);
    position: relative;
    overflow: hidden;
}
...
#header::before {
    ...
    animation: sweetBounce 18s ease infinite;
}
...
.ten-bao {
    ...
    letter-spacing: 9px;
    margin-bottom: 1.5rem;
    animation: peachGlow 3s ease infinite;
    text-shadow: 0 0 15px rgba(255, 196, 163, 0.7),
                 3px 3px 6px rgba(255, 112, 67, 0.4);
}
...
.ten-bao::before {
    ...
    margin-right: 1.5rem;
    font-size: 3.5rem;
    animation: bubbleFloat 2.5s ease infinite;
}
...
.ten-bao::after {
    ...
    margin-left: 1.5rem;
    font-size: 3.5rem;
    animation: bubbleFloat 2.5s ease infinite 1.25s;
}
...
.gioi-thieu {
    ...
    padding: 4rem;
    margin: 4rem 0;
    border: 3px solid #ffc4a3;
    border-radius: 32px;
    box-shadow: 0 15px 50px rgba(255, 184, 140, 0.35);
    position: relative;
}
...
.gioi-thieu h2 {
    ...
    font-weight: 700;
    letter-spacing: 6px;
    text-shadow: 0 2px 10px rgba(255, 196, 163, 0.5);
}
...
.bai-viet {
    ...
    border-radius: 28px;
    box-shadow: 0 10px 40px rgba(255, 184, 140, 0.28);
    transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1);
}

.bai-viet:hover {
    transform: translateY(-8px);
    box-shadow: 0 20px 60px rgba(255, 184, 140, 0.45);
    border-color: #ff7043;
}
...
.audio-player {
    background: linear-gradient(135deg, #ffc4a3 0%, #ffb88c 100%);
    padding: 2.5rem;
    margin: 3rem 0;
    border-radius: 28px;
    box-shadow: 0 10px 40px rgba(255, 184, 140, 0.4);
    text-align: center;
}
...
.khu-vuc-binh-luan textarea:focus {
    outline: none;
    border-color: #ff7043;
    box-shadow: 0 0 20px rgba(255, 184, 140, 0.35);
}

.nut-gui {
    background: linear-gradient(135deg, #ff7043 0%, #ff9966 100%);
    color: white;
    padding: 1.2rem 3rem;
    border: none;
    border-radius: 50px;
...
.nut-gui:hover {
    transform: translateY(-3px);
    box-shadow: 0 12px 35px rgba(255, 112, 67, 0.65);
...
.thong-tin-footer {
    ...
    letter-spacing: 3px;
    font-weight: 500;
    text-shadow: 0 2px 5px rgba(255, 112, 67, 0.4);
}
...
@media screen and (max-width: 768px) {
    ...
    theme14: `@import url('https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Roboto:wght@300;400;500;700;900&display=swap');
...
body::before {
    ...
    pointer-events: none;
    z-index: -1;
    animation: darkFlicker 5s ease infinite;
}
...
.ten-bao::before {
    ...
    margin-right: 2rem;
    font-size: 3rem;
    animation: shadowStrike 1s ease infinite;
}
...
.ten-bao::after {
    ...
    margin-left: 2rem;
    font-size: 3rem;
    animation: shadowStrike 1s ease infinite 0.5s;
}
...
.bai-viet:hover {
    transform: translateX(10px);
    box-shadow: -10px 10px 50px rgba(255, 0, 0, 0.5);
...
@media screen and (max-width: 768px) {
    ...
    theme15: `@import url('https://fonts.googleapis.com/css2?family=Orbitron:wght@400;500;600;700;900&family=Roboto+Mono:wght@300;400;500;600;700&display=swap');
...
.ten-bao {
    ...
    letter-spacing: 12px;
    margin-bottom: 1.5rem;
    animation: cyberGlow 2.5s ease infinite;
    position: relative;
}
...
.bai-viet {
    ...
    box-shadow: -5px 5px 30px rgba(52, 152, 219, 0.2);
    transition: all 0.4s ease;
    position: relative;
}
...
.bai-viet:hover {
    transform: translateX(10px);
    box-shadow: -15px 10px 50px rgba(52, 152, 219, 0.4);
